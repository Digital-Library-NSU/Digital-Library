...
class Book(Base):
    ...
    book_authors: Mapped[list['BookAuthor']] = relationship('BookAuthor', back_populates='book')
    book_identifiers: Mapped[list['BookIdentifier']] = relationship('BookIdentifier', back_populates='book')
    editions: Mapped[list['Edition']] = relationship('Edition', back_populates='book')
    content_chunks: Mapped[list['ContentChunk']] = relationship('ContentChunk', back_populates='book')


class BookAuthor(Base):
    __tablename__ = 'book_authors'
    __table_args__ = (
        ForeignKeyConstraint(['author_id'], ['authors.id'], ondelete='CASCADE', name='book_authors_author_id_fkey'),
        ForeignKeyConstraint(['book_id'], ['books.id'], ondelete='CASCADE', name='book_authors_book_id_fkey'),
...
class BookIdentifier(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(['book_id'], ['books.id'], ondelete='CASCADE', name='book_identifiers_book_id_fkey'),
        PrimaryKeyConstraint('book_id', 'scheme', 'value', name='book_identifiers_pkey'),
        UniqueConstraint('scheme', 'value', name='book_identifiers_scheme_value_key')
    )
    ...
    book: Mapped['Book'] = relationship('Book', back_populates='book_identifiers')


class Edition(Base):
    __tablename__ = 'editions'
    __table_args__ = (
        ForeignKeyConstraint(['book_id'], ['books.id'], ondelete='CASCADE', name='editions_book_id_fkey'),
    ...
    book: Mapped[Optional['Book']] = relationship('Book', back_populates='editions')
    edition_chapters: Mapped[list['EditionChapter']] = relationship('EditionChapter', back_populates='edition')
    content_chunks: Mapped[list['ContentChunk']] = relationship('ContentChunk', back_populates='edition')


class EditionChapter(Base):
    __tablename__ = 'edition_chapters'
    __table_args__ = (
        ForeignKeyConstraint(['edition_id'], ['editions.id'], ondelete='CASCADE', name='edition_chapters_edition_id_fkey'),
    ...
    edition: Mapped[Optional['Edition']] = relationship('Edition', back_populates='edition_chapters')
    content_chunks: Mapped[list['ContentChunk']] = relationship('ContentChunk', back_populates='chapter')


class ContentChunk(Base):
    __tablename__ = 'content_chunks'
    __table_args__ = (
        ForeignKeyConstraint(['book_id'], ['books.id'], ondelete='CASCADE', name='content_chunks_book_id_fkey'),
        ForeignKeyConstraint(['chapter_id'], ['edition_chapters.id'], ondelete='SET NULL', name='content_chunks_chapter_id_fkey'),
        ForeignKeyConstraint(['edition_id'], ['editions.id'], ondelete='CASCADE', name='content_chunks_edition_id_fkey'),
        PrimaryKeyConstraint('id', name='content_chunks_pkey'),
        UniqueConstraint('es_doc_id', name='content_chunks_es_doc_id_key'),
        Index('idx_chunks_book_ord', 'book_id', 'ord')
    )
    ...
    words_from: Mapped[Optional[int]] = mapped_column(Integer)
    words_to: Mapped[Optional[int]] = mapped_column(Integer)
    ...
    book: Mapped[Optional['Book']] = relationship('Book', back_populates='content_chunks')
    chapter: Mapped[Optional['EditionChapter']] = relationship('EditionChapter', back_populates='content_chunks')
    edition: Mapped[Optional['Edition']] = relationship('Edition', back_populates='content_chunks')
